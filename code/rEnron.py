...
#!      2. FILTER THE IMPORTANT ONES (SENT, ETC.)
#!      3. BUILD A DATASET THAT CONTAINS (FROM, TO, TIMESTAMP, MESSAGE (?), ...)

#? DIFICULTATS AFEGIDES: 
#?  1. LECTURA DE REPOSITORIS, LECTURA DE FITXERS MÉS COMPLEXA
#?  2. UN CORREU POT TENIR MÉS D'UN DESTINATARI - EL QUE NO PASSA AMB LES DADES DE JOGUINA.
#?  3. FILTRATGE DE PERSONAL QUE NO TENEN LES CARPETES CORRESPONENTS       
